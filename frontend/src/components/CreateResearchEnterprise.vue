<template>
  <div>
    ...
    <p>1. Если Продукт указан как 'main' - это исследование вносится на всю продукцию, кроме той которая указана в
      других строках</p>
    <p>2. Если Продукт указан (точное наименование продукции из Меркурия) - исследование вносится только на продукты с
      этим названием</p>
    <p>3. Если указан Продукт, но не заполнено хотя бы одно обязательное поле ('*' - необязательные поля) - исследования
